...
$opt_name = 'themeoption';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'page_title'                => esc_html__( 'Theme Options', 'portfolio' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Home', 'portfolio' ),
		'id'               => 'basic',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Footer Section', 'portfolio' ),
		'id'    => 'footer_section',
		'icon'  => 'el el-magic',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Social', 'portfolio' ),
		'id'    => 'social',
